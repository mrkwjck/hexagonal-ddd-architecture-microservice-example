...
class AccountDatabaseRepository implements AccountRepository {
    ...
    public void save(Account account) {
        ...
        var accountJpaEntity = accountJpaRepository.findByAccountNumber(account.getAccountNumber().toString())
            .map(entity -> {
    ...
    public Account findByAccountNumber(Iban accountNumber) {
        return accountJpaRepository.findByAccountNumber(accountNumber.toString())
